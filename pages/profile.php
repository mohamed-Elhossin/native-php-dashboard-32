...
$selectOne = "SELECT * FROM users where id =$profile_id";
$s = mysqli_query($connect, $selectOne);
      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <?php if (isset($_SESSION['message'])): ?>
            <div id="alert-invlid" class="alert alert-info alert-dismissible fade show" role="alert">
              <?= $_SESSION['message'] ?>
          ...
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            <img src="<?= URL('app/users/upload/') . $data['image'] ?>" alt="Profile" class="rounded-circle">
            <h2><?= $data['name'] ?></h2>
            <h3><?= $data['email'] ?></h3>
          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <!-- Profile Edit Form -->
                <form method="post" enctype="multipart/form-data" action="<?= URL("controller/profile.php") ?>">
                  <div class="row mb-3">
                    <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                    <div class="col-md-8 col-lg-9">
                      <img src="<?= URL("app/users/upload/") . $data['image'] ?>" alt="Profile">
                      <div class="pt-2">
                        <label for="image" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="text-light bi bi-upload"></i></label>
